...
required to run a [Timelord](https://github.com/Inan-Network/Inans-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Inan-Network/Inans-blockchain/blob/main/install-timelord.sh)
