...
from inan.pools.pool_wallet_info import PoolWalletInfo, PoolSingletonState
from inan.protocols import full_node_protocol
from inan.protocols.full_node_protocol import RespondBlock
...
from inan.simulator.simulator_protocol import FarmNewBlockProtocol, ReorgProtocol
...
class TestPoolWalletRpc:
    ...
    async def test_absorb_pooling(self, one_wallet_node_and_rpc):
        ...
        # Balance stars at 6 XGEN and 5 more blocks are farmed, total 22 XGEN
    ...
    async def test_leave_pool(self, setup):
        ...
        try:
            ...
            await time_out_assert(timeout=WAIT_SECS, function=have_inan)
