...
from inan.pools.pool_config import PoolWalletConfig
from inan.util.config import load_config, save_config, create_default_inan_config
...
def test_pool_config():
    ...
    create_default_inan_config(test_root, ["config.yaml"])
