...
from inan.types.blockchain_format.program import Program, SerializedProgram
...
wallet_program_files = set(
    [
        ...
        "inan/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "inan/wallet/puzzles/lock.inner.puzzle.clvm",
        "inan/wallet/puzzles/p2_conditions.clvm",
        "inan/wallet/puzzles/p2_delegated_conditions.clvm",
        "inan/wallet/puzzles/p2_delegated_puzzle.clvm",
        "inan/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "inan/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "inan/wallet/puzzles/p2_puzzle_hash.clvm",
        "inan/wallet/puzzles/rl_aggregation.clvm",
        "inan/wallet/puzzles/rl.clvm",
        "inan/wallet/puzzles/sha256tree_module.clvm",
        "inan/wallet/puzzles/singleton_top_layer.clvm",
        "inan/wallet/puzzles/did_innerpuz.clvm",
        "inan/wallet/puzzles/decompress_puzzle.clvm",
        "inan/wallet/puzzles/decompress_coin_solution_entry_with_prefix.clvm",
        "inan/wallet/puzzles/decompress_coin_solution_entry.clvm",
        "inan/wallet/puzzles/block_program_zero.clvm",
        "inan/wallet/puzzles/test_generator_deserialize.clvm",
        "inan/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "inan/wallet/puzzles/p2_singleton.clvm",
        "inan/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
        "inan/wallet/puzzles/pool_member_innerpuz.clvm",
        "inan/wallet/puzzles/singleton_launcher.clvm",
        "inan/wallet/puzzles/p2_singleton_or_delayed_puzhash.clvm",
    ]
)

clvm_include_files = set(
    ["inan/wallet/puzzles/create-lock-puzzlehash.clvm", "inan/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "inan/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to inan/wallet/puzzles, but not added to `wallet_program_files`
        """
