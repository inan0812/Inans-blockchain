...
- We build both MacOS x86_64 and MacOS universal wheels for inanpos, inanvdf, blpsy, and chiabip158 in Python 3.9. The universal build allows M1 Macs to run these dependencies in ARM64 native mode.
...
- There was a potential bug in Python 3.9.0 that required us to update blspy, inanpos, inanvdf, and chiabip158.
...
- Partial support for Python 3.9. That includes new versions of Inan dependencies like chiabip158.
...
- We added [lgtm](https://lgtm.com/) source analysis on pull request to the inan-blockchain, inanpos, inanvdf, chiabip158, and bls-library repositories to add some automated security analysis to our ci.
...
- The libraries inan-pos, inan-fast-vdf, and inan-bip-158 have been moved to their own repositories: [inanpos](https://github.com/Inan-Network/inanpos), [inanvdf](https://github.com/Inan-Network/inanvdf), and [chaibip158](https://github.com/Inan-Network/chiabip158). They are brought in by inan-blockchain at install time. Our BLS signature library remains at [bls-signatures](https://github.com/Inan-Network/bls-signatures).
