...
from inan.cmds.configure import configure_cmd
from inan.cmds.farm import farm_cmd
from inan.cmds.init import init_cmd
from inan.cmds.keys import keys_cmd
from inan.cmds.netspace import netspace_cmd
from inan.cmds.plots import plots_cmd
from inan.cmds.show import show_cmd
from inan.cmds.start import start_cmd
from inan.cmds.stop import stop_cmd
from inan.cmds.wallet import wallet_cmd
from inan.cmds.plotnft import plotnft_cmd
...
@click.group(
    help=f"\n  Manage inan blockchain infrastructure ({__version__})\n",
    epilog="Try 'inan start node', 'inan netspace -d 192', or 'inan show -s'",
...
@cli.command("version", short_help="Show inan version")
def version_cmd() -> None:
    print(__version__)


@cli.command("run_daemon", short_help="Runs inan daemon")
@click.pass_context
def run_daemon_cmd(ctx: click.Context) -> None:
    from inan.daemon.server import async_run_daemon
    import asyncio
