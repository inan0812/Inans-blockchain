...
def init_cmd(ctx: click.Context, create_certs: str):
    ...
    - Make a copy of your Farming Machine CA directory: ~/.inan/[version]/config/ssl/ca
    - Shut down all inan daemon processes with `inan stop all -d`
...
if __name__ == "__main__":
    from .init_funcs import inan_init
    from inan.util.default_root import DEFAULT_ROOT_PATH

    inan_init(DEFAULT_ROOT_PATH)
