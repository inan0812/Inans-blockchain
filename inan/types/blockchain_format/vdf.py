...
from inanvdf import create_discriminant, verify_n_wesolowski
...
from inan.types.blockchain_format.sized_bytes import bytes32, bytes100
from inan.util.ints import uint8, uint64
