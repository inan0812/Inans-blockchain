...
from inan.consensus.cost_calculator import calculate_cost_of_program, NPCResult
...
from inan.types.announcement import Announcement
...
from inan.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import (
    DEFAULT_HIDDEN_PUZZLE_HASH,
    calculate_synthetic_secret_key,
    puzzle_for_pk,
    solution_for_conditions,
)
from inan.wallet.puzzles.puzzle_utils import (
...
from inan.wallet.secret_key_store import SecretKeyStore
from inan.wallet.sign_coin_solutions import sign_coin_solutions
...
class Wallet:
    ...
    async def create_spend_bundle_relative_inan(self, inan_amount: int, exclude: List[Coin]) -> SpendBundle:
        list_of_solutions = []
        utxos = None
        ...
        if inan_amount < 0:
            utxos = await self.select_coins(abs(inan_amount), exclude)
        else:
        ...
        inan_amount = spend_value + inan_amount
        ...
        for coin in utxos:
            ...
            if output_created is None:
                ...
                primaries = [{"puzzlehash": newpuzhash, "amount": inan_amount}]
