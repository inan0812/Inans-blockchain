...
from inan.protocols.wallet_protocol import RespondAdditions, RejectAdditionsRequest
...
from inan.util.ints import uint64, uint32, uint8

from inan.wallet.did_wallet.did_info import DIDInfo
from inan.wallet.lineage_proof import LineageProof
