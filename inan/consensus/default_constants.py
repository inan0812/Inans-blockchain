...
testnet_kwargs = {
    ...
    "NUMBER_ZERO_BITS_PLOT_FILTER": 12,  # H(plot signature of the challenge) must start with these many zeroes
    "MIN_PLOT_SIZE": 32,  # 32 for mainnet
    "MAX_PLOT_SIZE": 50,
    "SUB_SLOT_TIME_TARGET": 300,  # The target number of seconds per slot, mainnet 600
