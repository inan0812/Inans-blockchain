...
if [ "$NOTARIZE" ]; then
  electron-osx-sign Inan-darwin-arm64/Inan.app --platform=darwin \
...
mv Inan-darwin-arm64 ../build_scripts/dist/
cd ../build_scripts || exit

DMG_NAME="Inan-$INAN_INSTALLER_VERSION-arm64.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/Inan-darwin-arm64/Inan.app Inan-$INAN_INSTALLER_VERSION-arm64 \
